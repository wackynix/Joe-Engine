...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['JOETASTIC!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	public var noVocals:Bool = false;
	...
	override public function create()
	{
		...
		noVocals = ClientPrefs.getGameplaySetting('novocals', false);
		...
		timeTxt.setFormat(Paths.font("newFont.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("newFont.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("newFont.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	private function generateSong(dataPath:String):Void
	{
		...
		if (SONG.needsVoices && noVocals == false)
